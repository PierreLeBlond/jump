...
func get_velocity(delta: float) -> Vector2:
    maximum_lateral_velocity = parent.projectile_parameters.maximum_velocity * parent.projectile_parameters.run_factor if parent.movement_controller.wants_to_run() else parent.projectile_parameters.maximum_velocity
